  ...
  return (
    <footer className="bg-black text-white py-8 px-16">
      <div className="flex justify-between border-b border-gray-400 pb-4">
        ...
        <button className="border-2 border-solid border-brown hover:border-brown hover:text-softgray hover:bg-transparent bg-brown text-white text-sm font-semibold py-2 px-6 mb-2">
          Make an Appointment
        </button>
      </div>
